...
-- Below code returns error (missing data)
COPY supervisor_salaries
FROM 'C:\SQL\supervisor_salaries.csv'
WITH (FORMAT CSV, HEADER); 
-- Below code selects columns that exist in source file and also specified in db table
...
-- Adding Default Value to Column During Import
