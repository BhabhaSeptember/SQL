 ...
 WITH
  ...
  SELECT 
 	 ...
 	 population,
 	 plants,
 	 round((plants/population::numeric(10,1)) * 1000000, 1) AS plants_per_million
 ...
 SELECT max_temp,
   CASE 
 	 ...
 	 WHEN max_temp BETWEEN 70 AND 89 THEN 'Pleasantly warm'
 	 WHEN max_temp BETWEEN 50 AND 69 THEN 'Cold'
 	 WHEN max_temp BETWEEN 33 AND 49 THEN 'Unreasonably Cold'
 	 WHEN max_temp BETWEEN 20 AND 32 THEN 'Icey'
 	 ELSE 'Inhumane'
